...
import type { IFieldTextEmit, IFieldTextProps, TInputValue, TLabelAlign } from "@/components/types.ts";
...
const wrapperClasses = computed(() => {
	return {
		...
		[getLabelAlign(props.labelAlign ?? "top")]: true,
	};
});
...
function getLabelAlign(align: TLabelAlign) {
