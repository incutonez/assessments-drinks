...
import type { IBaseDialogEmits, IBaseDialogProps } from "@/components/types.ts";
import { injectActiveDialog } from "@/composables/app.ts";
...
const { activeDialog, setActiveDialog } = injectActiveDialog();
...
const dialogClasses = computed(() => activeDialog.value === rootEl.value ? "z-2" : "z-1");
