import type { ButtonHTMLAttributes, InputHTMLAttributes, MaybeRef, VNode } from "vue";
import type {
...
import type { RouteCreate } from "@/constants.ts";

export type ViewModelIdProp = number | typeof RouteCreate;
